...
document.addEventListener("DOMContentLoaded", function (event) {
	...
	let selectedLevel = document.getElementById("formRoom").querySelector("select[name=level]").getAttribute("value")

	if (selectedLevel) {
		let levelOptions = document.getElementById("formRoom").querySelector("select[name=level]").children
